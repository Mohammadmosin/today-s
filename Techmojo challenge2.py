...
def readfile(file):
    ...
    for line in out:
        ...
        if list1[3]=="start":
            ...
            a=datetime(int(starttime[0:4]),int(starttime[5:7]),int(starttime[8:10]),int(starttime[11:13]),int(starttime[14:16]))
            b=datetime(int(endtime[0:4]),int(endtime[5:7]),int(endtime[8:10]),int(endtime[11:13]),int(endtime[14:16]))
